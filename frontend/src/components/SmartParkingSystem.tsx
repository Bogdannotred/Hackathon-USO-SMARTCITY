...
import { MyParkingInfo } from "./MyParkingInfo";
import { RemainingTimeList } from "./RemainingTimeList";
import {
  ParkingSpotData,
  MyParkingData,
  ParkingHistoryEntry,
...
const SmartParkingSystem: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <main className="p-8 mx-auto my-0 max-w-[1200px] max-sm:p-4">
        <h1 className="mb-12 text-6xl font-extrabold text-center text-blue-950 max-sm:mb-6 max-sm:text-3xl">
        ...
        <div className="flex gap-5 max-md:flex-col">
          ...
          <aside className="ml-5 w-[30%] max-md:ml-0 max-md:w-full">
            <div className="p-6 my-6 rounded-3xl border border-solid shadow-2xl backdrop-blur-[10px] bg-white bg-opacity-90 border-white border-opacity-20">
              <h3 className="mb-4 text-xl font-semibold text-gray-700">
                Lotus - Remaining Time
              </h3>

              <RemainingTimeList entries={lotusRemainingTimes} />
            </div>
          </aside>
        </div>
      </main>
